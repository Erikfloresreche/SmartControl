...
btn.addEventListener('click', (e) => {
    if([...formulario$1.classList].includes('formulario-gasto--active')){
...
const cargarGastos = () => {
    ...
    if(gastos && gastos.length > 0 ) {
        ...
        //Si hay gastos eliminamos el mensaje que indica que no hay gastos
        ...
        //Nos aseguramos de que no haya gastos en el DOM:
        contenedorGastos$1.innerHTML = '';
        //Si no hay gastos activamos le mensaje que indica que no hay gastos
